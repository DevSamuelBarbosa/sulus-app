...
import { ArrowLeft, CheckCircle2, Home, RefreshCw } from 'lucide-react'
    ...
    <div className="flex min-h-svh flex-col items-center bg-tertiary px-6 py-6 text-tertiary-foreground">
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-6">
        <div className="rounded-2xl bg-white p-6 shadow-xl">
          {isUsed ? (
            <div className="grid h-[260px] w-[260px] place-items-center gap-3 px-4 text-center text-foreground">
        ...
        {!error && !isUsed && token && (
          <p className="select-all rounded-md bg-black/20 px-3 py-1.5 text-center font-mono text-xs text-tertiary-foreground/70">
            {token}
          </p>
        )}
        ...
        <p className="text-center text-sm text-tertiary-foreground/70">
          {isUsed
            ...
            : error
              ...
              : `Expira em ${secondsLeft}s — atualiza automaticamente`}
        </p>
